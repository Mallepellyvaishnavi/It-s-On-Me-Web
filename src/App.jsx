      ...
      <header className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          <a className="flex title-font font-medium items-center text-gray-900 mb-4 md:mb-0" href="#">
            ...
            <span className="ml-3 text-xl">It'sOnMe</span>
          </a>
        ...
        <div class="container mx-auto flex px-5 py-0 md:flex-row flex-col items-center">
          <div class="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <div class="flex justify-center">
              ...
              <button class="ml-4 inline-flex text-white bg-[#e63946] border-0 py-2 px-6 focus:outline-none hover:bg-gray-200 rounded text-lg">REQUEST A DEMO</button>
            </div>
          </div>
        ...
        <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
          <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left md:mt-0 mt-10">
            <a class="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
              ...
              <span class="ml-3 text-xl">IT'S ON ME</span>
            </a>
